...
const SignInPage: React.FC = () => {
  ...
  return (
    <div className="bg-white px-10 py-20 rounded-3xl border-2 border-gray xl:flex xl:justify-center xl:items-center w-full h-screen">
      <div className="xl:w-1/2">
        <h1 className="text-5xl font-semibold text-center">Rent-a-car</h1>
